        ...
        <div class="box form-box">
            <?php 
               if(isset($_POST['submit'])){
                ...
                $edit_query = mysqli_query($con,"UPDATE users SET Name='$name', Username='$username', Email='$email', Phonenumber='$phonenumber', Age='$age' WHERE Id=$id ") or die("error occurred");
